...
class ModuleDocs:
    ...
    def __init__(self, ctx):
        ...
        self.log = ctx.log
        self.vlog = ctx.vlog
        self.vlog("Target:", target_dir)
        self.vlog("Absolute target path:", mod_abs_path)
        self.vlog("Mod name:", mod_name)
        self.vlog("Relative target path:", rel_dir)
        self.vlog("Clean import name:", name)
...
class GatherInfo:
    ...
    def __init__(self, ctx):
        """
        :param ctx: contains project info and logging utils
        """
        self._ctx = ctx
        self.log = ctx.log
        self.vlog = ctx.vlog
        ...
        self.hgrc = HgRc()
        self.module_docs = ModuleDocs(ctx)
        self.log("Finished gathering info for {}".format(self.name))

        # Debug
        self.vlog("Pypirc: \n{}\n".format(self.pypirc))
        self.vlog("Gitconfig: \n{}\n".format(self.gitconfig))
        self.vlog("Hgrc: \n{}\n".format(self.hgrc))
        self.vlog("Module docs: \n{}\n".format(self.module_docs))
...
class FillFiles:
    ...
    def copy_files(self):
        ...
        self.vlog("Files copied successfully")
